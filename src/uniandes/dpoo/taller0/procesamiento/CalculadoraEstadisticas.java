...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Se obtiene el pais de un atleta
	 * @param nombreAtleta
	 * @return
	 */

	public Pais paisDeAtleta(String nombreAtleta)
	{
		Pais resultado = null;
	 ...
	 */
	public static Map<String, Integer> paisConMasMedallistas()
	{
