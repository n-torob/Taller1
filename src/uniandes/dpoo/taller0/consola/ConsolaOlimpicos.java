...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le pide al usuario el nombre de un atleta y retorna el nombre del pais al
	 * que representa.
	 */
	...
	private void ejecutarPaisdeAtleta()
	{
		...
		System.out.println("\n" + "Pais del atleta" + "\n");
		String nombreAtleta = input("\n" + "Ingrese el nombre del atleta a consultar: " + "\n");

		Pais paisdeAtleta = calculadora.paisDeAtleta(nombreAtleta);

		System.out.println("\n" + "El pais al que el atleta " + nombreAtleta + " representa es " + paisdeAtleta + "\n");
	}
